	...
	<li>
	<a href="https://daof.ordd.tk//#/user/{{Auth::user()->id}}"><i class="fa fa-book nav_icon"></i> Account Opening Form</a>
	</li>
	@endif
	<li>
	...
	<!--toggle button end-->
	<!--logo -->
	<img style="width: 100px; margin-top: 5px;" src="{{url('images/Orange-Room-Logo.png')}}" alt="">
	<!--//logo-->
